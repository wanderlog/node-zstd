...
describe('ZSTD Buffer Async', function () {
  describe('compress', function () {
    ...
    it('should compress text data with level=3', function (done) {
      testBufferAsync(zstd.compress, 'data.txt', 'data.txt.zst.03', done, { level: 9 })
    })
    ...
    it('should compress text data with dict=(new Buffer("hello zstd"))', function (done) {
      testBufferAsync(zstd.compress, 'data.txt', 'data.txt.zst.09.dict', done, {
        level: 9,
  ...
  describe('decompress', function () {
    ...
    it('should decompress text data with dict=(new Buffer("hello zstd"))', function (done) {
      testBufferAsync(zstd.decompress, 'data.txt.zst.09.dict', 'data.txt', done, {
        level: 9,
        dict: Buffer.from('hello zstd'),
      })
    })
